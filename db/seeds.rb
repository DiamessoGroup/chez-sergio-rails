...
Pizza.create(id: 0, name: 'Parmesana', price: 35,
             ...
             image: '/pizzas/parmesana-pizza.jpg', categories: ['Vegetarian', 'All'], best_seller: true)
...
Pizza.create(id: 1, name: 'Mexicana', price: 30,
               ...
               image: '/pizzas/mexicana-pizza.jpg', categories: ['Meat', 'Spicy', 'All'], best_seller: true)
...
Pizza.create(id: 2,name: 'Francesa', price: 39,
             ...
             image: '/pizzas/francesa-pizza.jpg', categories: ['Meat', 'All'], best_seller: true)
...
Pizza.create(id: 3,name: 'Dolce Vita', price: 42,
             ...
             image: '/pizzas/dolce-vita-pizza.jpg', categories: ['Meat', 'All'], best_seller: false)
...
Pizza.create(id: 4,name: 'Brooklyn Bridge', price: 42,
             ...
             image: '/pizzas/brooklyn-bridge-pizza.jpg', categories: ['Meat', 'Spicy', 'All'], best_seller: true)
...
Pizza.create(id: 5,name: 'Neptunes', price: 49,
             ...
             image: '/pizzas/neptunes-pizza.jpg', categories: ['Seafood', 'All'], best_seller: false)
...
Pizza.create(id: 6,name: 'Margherita White', price: 25,
             ...
             image: '/pizzas/margherita-white-pizza.jpg', categories: ['Vegetarian', 'All'], best_seller: false)
...
Pizza.create(id: 7,name: 'Calabrasi Norgina', price: 28,
             ...
             image: '/pizzas/calabrasi-norgina-pizza.jpg', categories: ['Seafood', 'Spicy', 'All'], best_seller: false)
...
Pizza.create(id: 8,name: "Madonna", price: 29,
             ...
             image: "/pizzas/madonna-pizza.jpg", categories: ["Vegetarian", "All"], best_seller: false)
